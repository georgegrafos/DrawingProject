...
public class DrawingList extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] bitches = {"alex", "alex", "alex", "alex"};
        ListAdapter bitchAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_expandable_list_item_1, bitches);
        ListView drawingView = (ListView) findViewById(R.id.drawList);
        drawingView.setAdapter(bitchAdapter);
    }
